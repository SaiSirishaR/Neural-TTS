...
wav_path = '../../../../data/arctic/cmu_us_slt_arctic/wav/'
text_path = '../../../../data/arctic/cmu_us_slt_arctic/etc/arctic.data'
data_path = 'data/'

# model ids are separate - that way you can use a new tts with an old wavernn and vice versa
# NB: expect undefined behaviour if models were trained on different DSP settings
voc_model_id = 'slt_mol'
tts_model_id = 'slt_lsa_smooth_attention'
